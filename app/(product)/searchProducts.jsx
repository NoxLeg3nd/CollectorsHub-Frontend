...
export default function SearchProducts() {
    ...
    const fetchResults = useCallback(async (searchQuery, pageToFetch, reset = false) => {
        ...
        try {
            const response = await api.get("/api/v1/searchProducts", {
                params: { userId: user.id, query: searchQuery.trim(), page: pageToFetch, size: PAGE_SIZE },
            });
        ...
        <SafeAreaView className="flex-1 bg-black">
            ...
            <View className="flex-row items-center px-4 pt-2 pb-4 border-b border-white">
                ...
                <View className="flex-1">
                    ...
                    <Text className="text-white text-[22px] font-extrabold">Search Products</Text>
                </View>
            </View>
            ...
            {!loading && !searched && (
                <View className="flex-1 items-center justify-center px-8">
                    ...
                    <Text className="text-slate-600 text-[13px] mt-2 text-center">
                        Find your products by name, category or collection.
                    </Text>
                </View>
            )}
